...
![alt text](images/notes/istio-in-action/채영/2-1.istio-system-components.png)
...
![alt text](images/notes/istio-in-action/채영/2-2.istio-system-detail.png)
...
```
![alt text](images/notes/istio-in-action/채영/2-3.port-forward.png)
...
![alt text](images/notes/istio-in-action/채영/2-4.repeat-requests.png)
...
```
![alt text](images/notes/istio-in-action/채영/2-5.kiali-overview.png)
...
![alt text](images/notes/istio-in-action/채영/2-6.kiali-traffic-graph.png)
display -> Traffic Animation을 켜면 점들이 이동하는 걸 확인할 수 있음
![alt text](images/notes/istio-in-action/채영/2-7.kiali-traffic-animation.png)
...
```
![istio-system](images/notes/istio-in-action/채영/image.png)
